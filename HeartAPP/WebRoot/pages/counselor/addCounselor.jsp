  ...
  <body>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">添加咨询师
	                    <a href="/HeartAPP/counselorAction">
						...
						<div class="panel-body">
							<div class="col-lg-6">
								...
								<div class="form-group">
									<input class="form-control" placeholder="*请输入咨询师名称*" 
										name="couName" type="text" required="required">
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="请输入身份证号" 
										name="couCard" type="number">
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="请输入咨询师电话" 
										name="couTel" type="tel">
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="请输入咨询师介绍" 
										name="couDes" type="text">
								</div>
								<div class="form-group">
