...
<html>
  <head>
    ...
    <!-- Timeline CSS -->
    <link href="/HeartAPP/dist/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/HeartAPP/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="/HeartAPP/bower_components/morrisjs/morris.css" rel="stylesheet">
...
<body>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <a href="/HeartAPP/normaluserAction">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">${resourceNum}</div>
                                    <div>资源数</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">${franchiseeNum}</div>
                                    <div>加盟商数</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">${counselorNum}</div>
                                    <div>咨询师数</div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="/HeartAPP/bower_components/raphael/raphael-min.js"></script>
    <script src="/HeartAPP/bower_components/morrisjs/morris.min.js"></script>
    <script src="/HeartAPP/js/morris-data.js"></script>
