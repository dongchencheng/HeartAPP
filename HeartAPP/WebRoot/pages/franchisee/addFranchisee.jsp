  ...
  <body>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">添加加盟商
	                    <a href="/HeartAPP/franchiseeAction">
						...
						<div class="panel-body">
							<div class="col-lg-6">
								...
								<div class="form-group">
									<input class="form-control" placeholder="*请输入负责人名称*" 
										name="adminName" type="text" autofocus="autofocus" required="required">
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="*请输入负责人手机*" 
										name="adminTel" type="tel" required="required">
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="*请输入加盟商名称*" 
										name="frName" type="text" required="required">
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="请输入国家" 
										name="frCountry" type="text">
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="请输入省份" 
										name="frProvience" type="text">
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="请输入介绍" 
										name="frDes" type="text">
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="请输入地址" 
										name="frAddress" type="text">
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="请输入说明" 
