  ...
  <body>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">添加级别
                    <a href="/HeartAPP/userlevelAction">
						...
						<div class="panel-body">
							<div class="col-lg-6">
								...
								<div class="form-group">
									<input class="form-control" placeholder="*请输入级别名称*"
										name="userLevelName" type="text"
										autofocus="autofocus" required="required">
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="*请输入级别说明"
										name="userLevelDes" type="text">
								</div>
