                ...
                <div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<a href="/HeartAPP/pages/user/userInformation/addUserlevel.jsp">
									...
									<tbody>
										<s:iterator value="list" var="f">
											<tr>
												...
												<td><s:property value="userLevelDes" /></td>
												<s:form action="userlevelAction" theme="simple">
												<s:token></s:token>
												<input name="idUserLevel" type="hidden" value="${idUserLevel}"/>
	...
	function turn(x){
		...
		if(x=="tpage"){
			...
			if(turnpage>${allpage}||turnpage<1){
				...
				window.location.href='/HeartAPP/userlevelAction?page='+turnpage;
			}
		}else{
			window.location.href='/HeartAPP/userlevelAction?page='+x;
			}
		}
