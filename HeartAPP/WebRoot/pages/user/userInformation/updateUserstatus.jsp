...
<html>
  ...
  <body>
	...
	<c:if test="${empty userstatus}">
		<c:redirect url="/userstatusAction" />
	</c:if>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">修改状态
                    <a href="/HeartAPP/userstatusAction?page=${page}">
								...
								<s:form action="userstatusAction" theme="simple">
									...
									<div class="form-group">ID
										<input class="form-control"  type="text"
											value="${idUserStatus}" name="idUserStatus"
											readonly="readonly">
									</div>
									<div class="form-group">状态名称*
										<input class="form-control"  type="text"
											value="${userstatus.userStatusName}" name="userStatusName"
											autofocus="autofocus" required="required">
									</div>
									<div class="form-group">状态说明
										<input class="form-control"  type="text"
											value="${userstatus.userStatusDes}" name="userStatusDes">
									</div>
