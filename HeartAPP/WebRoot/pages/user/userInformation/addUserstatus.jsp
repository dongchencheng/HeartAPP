  ...
  <body>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">添加状态
                    <a href="/HeartAPP/userstatusAction">
						...
						<div class="panel-body">
							<div class="col-lg-6">
								...
								<div class="form-group">
									<input class="form-control" placeholder="*请输入状态名称*"
										name="userStatusName" type="text"
										autofocus="autofocus" required="required">
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="*请输入状态说明"
										name="userStatusDes" type="text">
								</div>
