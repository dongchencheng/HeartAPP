                ...
                <div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<a href="/HeartAPP/pages/user/userInformation/addUsercreatetype.jsp">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<s:iterator value="list" var="f">
											<tr>
												<td><s:property value="idUserCreateType" /></td>
												<td><s:property value="userCreateTypeName" /></td>
												<td><s:property value="userCreateTypeDes" /></td>
												<s:form action="usercreatetypeAction" theme="simple">
												<s:token></s:token>
												<input name="idUserCreateType" type="hidden" value="${idUserCreateType}"/>
	...
	function turn(x){
		...
		if(x=="tpage"){
			...
			if(turnpage>${allpage}||turnpage<1){
				...
				window.location.href='/HeartAPP/usercreatetypeAction?page='+turnpage;
			}
		}else{
			window.location.href='/HeartAPP/usercreatetypeAction?page='+x;
			}
		}
