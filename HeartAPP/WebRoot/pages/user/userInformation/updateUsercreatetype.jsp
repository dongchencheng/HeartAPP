...
<html>
  ...
  <body>
  	...
  	<!-- 验证是否有值 -->
	<c:if test="${empty usercreatetype}">
		<c:redirect url="/usercreatetypeAction" />
	</c:if>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">修改来源
                    <a href="/HeartAPP/usercreatetypeAction?page=${page}">
								...
								<s:form action="usercreatetypeAction" theme="simple">
									...
									<div class="form-group">ID
										<input class="form-control"  type="text"
											value="${idUserCreateType}" name="idUserCreateType"
											readonly="readonly">
									</div>
									<div class="form-group">来源名称*
										<input class="form-control"  type="text"
											value="${usercreatetype.userCreateTypeName}" name="userCreateTypeName"
											autofocus="autofocus" required="required">
									</div>
									<div class="form-group">来源说明
										<input class="form-control"  type="text"
											value="${usercreatetype.userCreateTypeDes}" name="userCreateTypeDes">
									</div>
