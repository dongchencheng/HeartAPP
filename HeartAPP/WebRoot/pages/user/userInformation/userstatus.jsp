                ...
                <div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<a href="/HeartAPP/pages/user/userInformation/addUserstatus.jsp">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<s:iterator value="list" var="f">
											<tr>
												<td><s:property value="idUserStatus" /></td>
												<td><s:property value="userStatusName" /></td>
												<td><s:property value="userStatusDes" /></td>
												<s:form action="userstatusAction" theme="simple">
												<s:token></s:token>
												<input name="idUserStatus" type="hidden" value="${idUserStatus}"/>
	...
	function turn(x){
		...
		if(x=="tpage"){
			...
			if(turnpage>${allpage}||turnpage<1){
				...
				window.location.href='/HeartAPP/userstatusAction?page='+turnpage;
			}
		}else{
			window.location.href='/HeartAPP/userstatusAction?page='+x;
			}
		}
