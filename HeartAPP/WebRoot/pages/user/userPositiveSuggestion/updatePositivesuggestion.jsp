...
<html>
  ...
  <body>
  	...
  	<!-- 验证是否有值 -->
	<c:if test="${empty positivesuggestion}">
		<c:redirect url="/positivesuggestionAction" />
	</c:if>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">修改宣泄信息
	                    <a href="/HeartAPP/positivesuggestionAction?page=${page}&SpositiveContent=${SpositiveContent}">
						...
						<div class="panel-body">
							<div class="col-lg-6">
								<s:form action="positivesuggestionAction" theme="simple">
									...
									<s:token></s:token>
									<div class="form-group">积极暗示ID
										<input class="form-control" type="text"
										value="${positivesuggestion.idPositiveSuggestion}"
										name="idPositiveSuggestion" readonly="readonly">
									</div>
									<div class="form-group">积极暗示文字*
									<input class="form-control" name="positiveContent"
									value="${positivesuggestion.positiveContent}" type="text"
									autofocus="autofocus" required="required">
									</div>
									<div class="form-group">积极暗示图像
										<input class="form-control" name="positiveImage"
										value="${positivesuggestion.positiveImage}" type="text">
									</div>
									<div class="form-group">资源
										<select name="idResource" class="form-control">
											<s:iterator value="resourceList" var="f">
												<c:choose>
													<c:when test="${positivesuggestion.idResource==idResource}">
														<option selected="selected" value="${idResource}">
									...
									<div class="form-group">说明
										<input class="form-control"
											value="${positivesuggestion.notes}" name="notes" type="text">
									</div>
