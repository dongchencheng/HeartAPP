								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<s:iterator value="list" var="f">
											<tr>
												<td><s:property value="nuserclicked.idUserClicked" /></td>
												<td><s:property value="nuserclicked.idUser" /> <s:property value="DUserName" /></td>
												<td><s:property value="nuserclicked.idResource" /> <s:property value="DResourceName" /></td>
												<td><s:property value="nuserclicked.clickTime" /></td>
												<td><s:property value="nuserclicked.notes" /></td>
											</tr>
										</s:iterator>
										<tr>
										<tr>
	...
	function turn(x){
		...
		if(x=="tpage"){
			...
			if(turnpage>${allpage}||turnpage<1){
				...
				window.location.href='/HeartAPP/nuserclickedAction?page='+turnpage;
			}
		}else{
			window.location.href='/HeartAPP/nuserclickedAction?page='+x;
			}
		}
	</script>
</body>
