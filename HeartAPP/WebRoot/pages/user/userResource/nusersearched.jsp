								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<s:iterator value="list" var="f">
											<tr>
												<td><s:property value="nusersearched.idUserSearched" /></td>
												<td><s:property value="nusersearched.idUser" /> <s:property value="DUserName" /></td>
												<td><s:property value="nusersearched.searchInfo" /></td>
												<td><s:property value="nusersearched.searchSql" /></td>
												<td><s:property value="nusersearched.searchResult" /></td>
												<td><s:property value="nusersearched.searchTime" /></td>
												<td><s:property value="nusersearched.notes" /></td>
											</tr>
										</s:iterator>
										<tr>
										<tr>
	...
	function turn(x){
		...
		if(x=="tpage"){
			...
			if(turnpage>${allpage}||turnpage<1){
				...
				window.location.href='/HeartAPP/nusersearchedAction?page='+turnpage;
			}
		}else{
			window.location.href='/HeartAPP/nusersearchedAction?page='+x;
			}
		}
	</script>
</body>
