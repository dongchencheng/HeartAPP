								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<s:iterator value="list" var="f">
											<tr>
												<td><s:property value="usercollect.idUserCollect" /></td>
												<td><s:property value="usercollect.idUser" /> <s:property value="DUserName" /></td>
												<td><s:property value="usercollect.idResource" /> <s:property value="DResourceName" /></td>
												<td><s:property value="usercollect.collectTime" /></td>
												<td><s:property value="usercollect.notes" /></td>
											</tr>
										</s:iterator>
										<tr>
										<tr>
	...
	function turn(x){
		...
		if(x=="tpage"){
			...
			if(turnpage>${allpage}||turnpage<1){
				...
				window.location.href='/HeartAPP/usercollectAction?page='+turnpage;
			}
		}else{
			window.location.href='/HeartAPP/usercollectAction?page='+x;
			}
		}
	</script>
</body>
