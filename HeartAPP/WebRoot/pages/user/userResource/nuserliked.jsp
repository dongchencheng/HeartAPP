								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<s:iterator value="list" var="f">
											<tr>
												<td><s:property value="nuserliked.idUserLiked" /></td>
												<td><s:property value="nuserliked.idUser" /> <s:property value="DUserName" /></td>
												<td><s:property value="nuserliked.idResource" /> <s:property value="DResourceName" /></td>
												<td><s:property value="nuserliked.likeTime" /></td>
												<td><s:property value="nuserliked.notes" /></td>
											</tr>
										</s:iterator>
										<tr>
										<tr>
	...
	function turn(x){
		...
		if(x=="tpage"){
			...
			if(turnpage>${allpage}||turnpage<1){
				...
				window.location.href='/HeartAPP/nuserlikedAction?page='+turnpage;
			}
		}else{
			window.location.href='/HeartAPP/nuserlikedAction?page='+x;
			}
		}
	</script>
</body>
