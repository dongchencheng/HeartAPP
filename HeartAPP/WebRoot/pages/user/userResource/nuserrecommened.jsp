								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<s:iterator value="list" var="f">
											<tr>
												<td><s:property value="nuserrecommened.idUserRecommened" /></td>
												<td><s:property value="nuserrecommened.idUser" /> <s:property value="DUserName" /></td>
												<td><s:property value="nuserrecommened.idResource" /> <s:property value="DResourceName" /></td>
												<td><s:property value="nuserrecommened.listenStatus" /></td>
												<td><s:property value="nuserrecommened.createTime" /></td>
												<td><s:property value="nuserrecommened.notes" /></td>
											</tr>
										</s:iterator>
										<tr>
										<tr>
	...
	function turn(x){
		...
		if(x=="tpage"){
			...
			if(turnpage>${allpage}||turnpage<1){
				...
				window.location.href='/HeartAPP/nuserrecommenedAction?page='+turnpage;
			}
		}else{
			window.location.href='/HeartAPP/nuserrecommenedAction?page='+x;
			}
		}
	</script>
</body>
